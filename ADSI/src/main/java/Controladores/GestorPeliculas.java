...
public class GestorPeliculas {
    ...
    public JSONArray mostrarPeliculas() {
        ...
        if (this.catalogoPelis.size() > 0) { // Verifica si hay pelï¿½culas en el catï¿½logo
            ...
            System.out.println("No hay peliculas en el catalogo."); // Mensaje si no hay pelï¿½culas
        }

        return peliculas; // Devuelve el catï¿½logo de pelï¿½culas (vacï¿½o si no hay pelï¿½culas)
    }
	...
	public JSONArray mostrarCatalogoAmpliado(String pTitulo) {
	    ...
	    if (resultados != null) {
	        ...
	        if (json.has("Search")) {
	            ...
	            System.out.println("No se encontraron pelÃ­culas.");
	        }
	    }
	    return jsonArray;
	}
